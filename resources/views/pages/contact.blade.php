<x-app-layout>
    ...
    @push('scripts')
        <script>
            var map = L.map('map').setView([6.18948809194407, -75.60169958088075], 16);
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
            }).addTo(map);
            L.marker([6.18948809194407, -75.60169958088075]).addTo(map)
                .bindPopup('<span class="font-bold">Fundación Lucari<span><br><small class="text-center"><a href="https://maps.app.goo.gl/LZ7dAck2a1hGAPM9A" target="_blank" class="text-center">Ver en Google Maps</a></small>')
                .openPopup();
        </script>
    @endpush
</x-app-layout>
