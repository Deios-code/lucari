...
<div id="drawer-navigation" class=" fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full" tabindex="-1" aria-labelledby="drawer-navigation-label">
    <h5 id="drawer-navigation-label" class=" font-semibold text-gray-500 uppercase">Menu</h5>
    ...
    <div class="py-4 overflow-y-auto">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/nosotros" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <span class="ms-3">Nosotros</span>
                </a>
            </li>
            <li>
                <a href="/nuestros-programas" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <span class="ms-3">Programas de la fundación</span>
                </a>
            </li>
            <li>
                <a href="/nuestras-historias" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <span class="ms-3">Historias</span>
                </a>
            </li>
            <li>
                <a href="/informes-gestion" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <span class="ms-3">Informes de gestión</span>
                </a>
            </li>
            <li>
                <a href="/contacto" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
